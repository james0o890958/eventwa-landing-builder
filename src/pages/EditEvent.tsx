...
const EditEvent = () => {
  ...
  const validateStep = (s: number) => {
    ...
    if (s === 3 && !form.isFree) {
      for (const t of form.ticketTiers) {
        if (!t.name.trim()) {
          toast.error("All ticket tiers need a name.");
          return false;
        }
  ...
  const addTier = () =>
    set("ticketTiers", [
      ...form.ticketTiers,
      { id: `t${Date.now()}`, name: "", price: "", quantity: "", description: "" },
    ]);
  ...
  const inputCls =
    "bg-secondary border-border/50 text-foreground placeholder:text-muted-foreground";
              ...
              <div className="space-y-6 rounded-2xl border border-border/50 bg-card p-6 shadow-card">
                ...
                {field(
                  ...
                  <div className="space-y-3">
                    ...
                    <p className="text-xs text-muted-foreground">
                      Current banner shown above. Enter a URL to replace it.
                    </p>
                  </div>,
                )}
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-2">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-muted-foreground">
                          Allow brands to sponsor your event
                        </p>
                      </div>
                    </div>
                    <button
        ...
        <div className="mt-8 flex items-center justify-between">
          ...
          {step < 4 ? (
            ...
            <Button
              onClick={handleSave}
              disabled={submitting}
              className="gradient-primary text-primary-foreground shadow-glow gap-2 min-w-[160px] disabled:opacity-60"
            >
              {submitting ? (
